...
export default function RulesThird() {
  const pointsData = [
    { points: "+50", Icon: ThumbsUp },
    { points: "+100", Icon: MessageCircle },
    { points: "+100", Icon: Share },
  ];
